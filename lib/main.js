...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const workingDirectory = path_1.default.resolve(process.cwd(), core.getInput('workingDirectory') || '.');
            releaseDir = path_1.default.resolve(workingDirectory, releaseDir);
            ...
            if (releaseFiles !== undefined && releaseFiles.length !== 0) {
                ...
                for (let releaseFile of releaseFiles) {
                    ...
                    if (releaseFile.name.endsWith('.apk')) {
                        signedReleaseFile = yield signing_1.signApkFile(releaseFilePath, signingKey, alias, keyStorePassword, keyPassword, workingDirectory);
                    }
                    else if (releaseFile.name.endsWith('.aab')) {
                        signedReleaseFile = yield signing_1.signAabFile(releaseFilePath, signingKey, alias, keyStorePassword, keyPassword, workingDirectory);
                    }
                    else {
